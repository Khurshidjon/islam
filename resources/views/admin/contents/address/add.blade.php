                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <input type="text" name="phone" class="form-control {{ $errors->has('phone') ? ' is-invalid' : '' }}" placeholder="+998901234567" value="{{ old('phone') }}">
                                @if ($errors->has('phone'))
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" name="email" class="form-control {{ $errors->has('email') ? ' is-invalid' : '' }}" placeholder="mail@example.com" value="{{ old('email') }}">
                                @if ($errors->has('email'))
                                    <span class="invalid-feedback" role="alert">
                        ...
                        <div class="tab-content">
                            ...
                            <div id="home" class="container tab-pane active"><br>
                                ...
                                <input id="address_uz" type="text" class="form-control {{ $errors->has('address_uz') ? ' is-invalid' : '' }}" name="address_uz" placeholder="Manzil" value="{{ old('address_uz') }}" autocomplete="off">
                            ...
                            <div id="menu1" class="container tab-pane fade"><br>
                                ...
                                <input id="address_ru" type="text" class="form-control {{ $errors->has('address_ru') ? ' is-invalid' : '' }}" name="address_ru" placeholder="Адрес" value="{{ old('address_ru') }}" autocomplete="off">
                            ...
                            <div id="menu2" class="container tab-pane fade"><br>
                                ...
                                <input id="address_en" type="text" class="form-control {{ $errors->has('address_en') ? ' is-invalid' : '' }}" name="address_en" placeholder="Address" value="{{ old('address_en') }}" autocomplete="off">
